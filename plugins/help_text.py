...
async def start_me(bot, update):
    ...
    if update_channel:
        try:
            user = await bot.get_chat_member(update_channel, update.chat.id)
            if user.status == "kicked":
               await update.reply_text(" Sorry,You've Been Flooding Me So My Owner Removed You From Using Me If You Think It's An Error Contact : @Arishem_TheJudge")
               return
        except UserNotParticipant:
            await update.reply_text(
                text="**Due To The Huge Traffic Only Channel Members Can Use This Bot Means You Need To Join The Below Mentioned Channel Before Using Me! **",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Channel', url='https://t.me/Ott_streaming_updates'),
                    InlineKeyboardButton('Channel 2', url='https://t.me/Ott_streaming_updates')
                ],
                [
                    InlineKeyboardButton('Channel 3', url='https://t.me/Ott_streaming_updates'),
                    InlineKeyboardButton('Channel 4', url='https://t.me/Ott_streaming_updates')
                ]
            ]
        ),
